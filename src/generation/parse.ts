...
const NOT_CERTIFIED: [RegExp, string][] = [
  ...
  [/\bskull\s?crushers?\b/, 'a skull crusher is a lying elbow-extension variant; the current extension family certifies standing overhead extensions and cable pushdowns only.'],
