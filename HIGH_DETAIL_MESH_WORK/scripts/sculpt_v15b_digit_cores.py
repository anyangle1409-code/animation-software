"""Candidate-only V15b finger-shaft reconstruction in the prepared Blender file.
...
BLEND = ROOT / "HomeGymPT_Male_HIGH_DETAIL_CANDIDATE_v15b_deep_hand_rebuild.blend"
REPORT = ROOT / "reports" / "sculpt_v15b_digit_cores.json"
