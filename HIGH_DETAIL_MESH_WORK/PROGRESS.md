...
# 2026-09-24 — V14 finger-body experiment

Created an isolated V14 branch from the V13e checkpoint. A read-only Blender probe located long interior finger edges. V14a/b were no-op filter diagnostics; V14c exposed a source-ID bookkeeping mistake before export; V14d was a valid low-strength trial with only 0.18 mm source-vertex movement and an imperceptible visual change. V14e split 2,737 finger-body edges and used stronger constrained relaxation, reaching 98,627 body triangles and at most 1.086 mm of source-vertex displacement. No protected floor-contact vertex, hand patch boundary, or non-finger body vertex moved.

V14e GLB and bare variant pass structural checks, strict 682-vertex floor guard, five focused guards, bare/dressed equivalence and seven exercises over 26 frames against runtime `614033b`. Bone and equipment matrices match exactly, push-up floor height is identical, and the hand seams and folded-edge count match V13e. Matched open hand, fist and exercise boards show only a small visual improvement: the broad finger shaft silhouette and segmented areas remain. **V14e is experimental and not accepted.** Preserve V8, V13e and V14e. Next attempt must rebuild local finger shaft/joint surface geometry instead of another global smoothing field. Grip refit remains untouched.

# 2026-09-25 — V15 deep-hand attempts

Started from the prepared V13e diagnostic Blend and preserved V15a–V15e as separate attempts. V15a's strong radial/edge-flow pass produced 95 severe digit folds versus V13e's 3 and visible pinching. V15b's conservative pass preserved all stable IDs, exact 682 push-up contacts, bare/dressed equivalence and the frozen 63-bone exercise behavior, but its matched review still shows segmented shafts and the bind seam audit worsened from 4 to 8 severe folds. V15c had invalid stable-ID tracking; V15d only processed one digit; V15e added 1,165 local PIP/DIP control vertices across eight fingers but again worsened folds. None is accepted or promoted. The production reference passed 95/95 current-source focused tests, but V15b current-source integration was stopped after the separate anatomy gate had already failed. The attempt manifest, binaries, review boards, measured reports and exact next action are in `V15_SESSION_2026-09-25.md`. Grip refitting remains on hold.
