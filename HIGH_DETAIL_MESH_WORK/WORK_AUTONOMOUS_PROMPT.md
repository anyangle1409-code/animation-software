...
>
> Run `HIGH_DETAIL_MESH_WORK/RESUME_WORK.bat`. It must prepare the isolated `validation_63` tree from exact source commit `19ca602ca2f2a821237dcf5b1b50c7906d86b0fe`. Do not validate new candidates only against the older 53-bone snapshot.
>
...
>
> Do not change the frozen canonical hierarchy. Treat mirrored hand roll and production palm-bone placement as retarget/asset issues.
>
