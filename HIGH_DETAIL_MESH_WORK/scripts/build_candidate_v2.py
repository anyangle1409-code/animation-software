...
dest=R/'HomeGymPT_Male_HIGH_DETAIL_CANDIDATE_v2.glb';dest.write_bytes(glb)
...
(R/'reports/build_v2.json').write_text(json.dumps(report,indent=2));print(json.dumps(report),flush=True)
...
bpy.ops.wm.save_as_mainfile(filepath=str(R/'HomeGymPT_Male_HIGH_DETAIL_CANDIDATE_v2.blend'))
bpy.ops.wm.save_as_mainfile(filepath=str(R/f'checkpoints/CANDIDATE_v2_03_surface_gain_{gain:.2f}.blend'),copy=True)
