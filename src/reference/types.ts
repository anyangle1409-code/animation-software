...
export type ReferenceFamilyId = 'curl' | 'overhead_press' | 'squat' | 'lunge' | 'hinge' | 'row' | 'vertical_pull' | 'raise' | 'extension' | 'horizontal_press' | 'calf' | 'trunk_flexion' | 'supine' | 'carry';
...
export interface ReferenceApplicability {
  ...
  support?: 'standing' | 'seated' | 'incline' | 'hanging' | 'floor' | 'bench' | 'walking';
}
