"""Candidate-only V15c finger-shaft reconstruction in the prepared Blender file.
...
BLEND = ROOT / "HomeGymPT_Male_HIGH_DETAIL_CANDIDATE_v15c_deep_hand_rebuild.blend"
REPORT = ROOT / "reports" / "sculpt_v15c_digit_cores.json"
