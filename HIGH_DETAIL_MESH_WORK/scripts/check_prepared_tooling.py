...
REQUIRED = [
    ...
    "PROJECT_CONTROLLER_CONFIG.json",
    "PROJECT_CONTROLLER.md",
    "END_WORK_TASK.bat",
    "START_WORK_TASK.bat",
    "FINISH_WORK_TASK.bat",
    "BEGIN_NEXT_WORK_TASK.bat",
    "PREPARE_NEXT_WORK_TASK.bat",
    "PLAN_WORK_TASK.bat",
    "COMPARE_WORK_MODELS.bat",
    "ESTIMATE_WORK_USAGE.bat",
    "WORK_USAGE_ESTIMATOR.md",
    "PROGRESS_PER_USAGE.md",
    "USAGE_VALUE_POLICY.json",
    "PRINT_V15F_WORK_PROMPT.bat",
    "PRINT_CLAUDE_TASK_PROMPT.bat",
    "AI_TASK_ROUTING.md",
    "LOW_USAGE_SESSION_TEMPLATES.md",
    "STOP_V15F_SAFE_RUNNER.bat",
    "START_V15F_SAFE_RUNNER.bat",
    "WRITE_V15F_HANDOFF.bat",
    "MARK_V15F_STAGE_B_VISUAL.bat",
    "OPEN_V15F_STAGE_B_VISUAL.bat",
    "GENERATE_V15F_STAGE_B_VISUAL.bat",
    "AUDIT_V15F_STAGE_B_DIGIT.bat",
    "V15F_STAGE_B_PLAN.md",
    "MARK_V15F_STAGE_A_VISUAL.bat",
    "OPEN_V15F_STAGE_A_VISUAL_PROOF.bat",
    "GENERATE_V15F_STAGE_A_VISUAL_PROOF.bat",
    "MARK_V15F_RING_VISUAL.bat",
    "OPEN_V15F_RING_VISUAL_PROOF.bat",
    "GENERATE_V15F_RING_VISUAL_PROOF.bat",
