...
export type GeneratorFamilyId = 'curl' | 'overhead_press' | 'squat' | 'lunge' | 'hinge' | 'row' | 'vertical_pull' | 'extension' | 'raise' | 'calf' | 'carry';
...
export type IntentSupport = 'standing' | 'seated' | 'incline' | 'hanging' | 'walking';
