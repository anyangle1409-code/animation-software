...
export type GeneratorFamilyId = 'curl' | 'overhead_press' | 'squat' | 'lunge' | 'hinge' | 'row' | 'vertical_pull' | 'extension' | 'raise' | 'calf' | 'carry' | 'trunk_flexion';
...
export type IntentSupport = 'standing' | 'seated' | 'incline' | 'hanging' | 'walking' | 'lying';
...
export interface ExerciseIntent {
  ...
  /** Which certified trunk-flexion motion to use. */
